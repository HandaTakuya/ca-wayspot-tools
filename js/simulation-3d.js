...
const CA_Simulation3D = (() => {
    ...
    // ขึ้นอีก 50% จากตรงนั้น แล้วใหญ่ขึ้นอีก 30% ต่อจากนั้นอีกที
    // (1.3*1.5*1.3=2.535), PokeStop ลดลง 20% จากตรงนั้น (1.3*0.8=1.04),
    // Power Spot ลดลง 15% จากตรงนั้น (1.3*0.85=1.105)
    const MODEL_SCALE = {
        pokestop: 1.3 * 0.8,
        gym: 1.3 * 1.5 * 1.3,
        caspot: 1.3,
