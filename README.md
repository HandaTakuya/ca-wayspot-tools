...
- **🔗 Live Project Share:** ระบบแชร์โครงการผ่านลิงก์ (URL) โดยไม่ต้องใช้เซิร์ฟเวอร์ สะดวกต่อการแชร์แผนให้เพื่อน
...
- **💾 JSON & KML Data:** รองรับการนำเข้าและส่งออกข้อมูลทั้งรูปแบบ JSON และ KML
- **🌐 S2 Cell Overlay:** แสดงเส้นขอบเขต S2 Cell ระดับ L14 และ L17 อย่างแม่นยำ
